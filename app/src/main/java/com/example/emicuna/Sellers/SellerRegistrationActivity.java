...
public class SellerRegistrationActivity extends AppCompatActivity {
    ...
    private void registerSeller() {
                    ...
                    if (task.isSuccessful()){
                        ...
                        rootRef.child("Sellers").child(sid).updateChildren(sellerMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                loadingBar.dismiss();
                                Toast.makeText(SellerRegistrationActivity.this,"Registro exitoso", Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(this,"Porfavor complete el formulario de registro.", Toast.LENGTH_SHORT).show();
        }
